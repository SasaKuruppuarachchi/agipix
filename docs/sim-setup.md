...
### Nucleus Server
[Download](https://docs.omniverse.nvidia.com/install-guide/latest/workstation-install.html) and install Omniverse Launcher and install [Nucleus Server](https://docs.omniverse.nvidia.com/launcher/latest/workstation-launcher.html#collaboration-tab). Go to the library and install ISAACSIM.
...
```
If PX4 launched properly you can exit out of it. For further information [visit here](https://docs.px4.io/main/en/dev_setup/building_px4.html)
...
4. Opening the UI
   ...
   1. Open up a [Foxglove](https://app.foxglove.dev/) account and navigate to the dashboard
   2. Open connection with "ws://localhost:8765"

Now we are ready for autonomy setup. See the [Autonomy Framework]({{ '/docs/autonomy.html' | relative_url }}) to continue.
